...
export const BASE_SITE_LINK = process.env.BASE_URL
export const API_LIST_POSTS = process.env.BASE_URL + '/api/posts/newest';
export const API_POST = process.env.BASE_URL + '/api/p/'
